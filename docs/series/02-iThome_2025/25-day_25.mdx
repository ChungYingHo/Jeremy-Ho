...
sidebar_label: "Day25 -  面試問我開發環境以及流程耶~ 我該怎麼回答？"
unlisted: true
tags: [git, vscode, docker]
keywords: [git, vscode, docker]
---
...
想知道怎麼安裝 git 或是了解一些實用的 git 指令，可以參考我的 [Git 安裝與使用](https://jeremyho.tw/docs/notes/Env/git) 一文。  
...
它們各自對於 branch 的使用規範不太一樣，但目的都是希望能讓多人協作開發時，能夠更有效率地管理 code、減少 conflict 的產生、減少破壞性的 commit & 影響其啊 branch 的機會。  
...
我之前有整理一份 vscode extension 相關的[文章](https://jeremyho.tw/docs/notes/Env/vscode#vscode-%E6%8F%92%E4%BB%B6)，有興趣也可以看看。
...
那在多人協作下，也不會再有「我本機可以跑，為什麼你那邊不行？」的問題。  
甚至如果是在同一台開發機的 docker 中分配各自的 port 各自開發，每個人都在自己的 container 裡作業，這樣就更能確保環境一致性了。  
