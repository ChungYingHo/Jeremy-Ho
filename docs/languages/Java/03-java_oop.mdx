...
public class Inherit_01 {
    public static void main(String[] args) {
        ...
        System.out.println("請輸入飛機物件 airplane 之相關資訊: ");
        String line = scanner.nextLine(); // 洛克希德馬丁 F-16 Chinese-1 A0001 1 3986 像鯊魚

        String[] parts = line.split(" ");

        String inputManufacturer = parts[0];
        String inputFlightVehileType = parts[1];
        String inputFlightVehileId = parts[2];
        String inputEngineId = parts[3];
        int inputPilotAmount = Integer.parseInt(parts[4]);
        int inputFuelContent = Integer.parseInt(parts[5]);
        String inputFlightVehileDesc = parts[6];

        scanner.close();

        Airplane airplane = new Airplane(inputFlightVehileDesc, inputManufacturer, inputFlightVehileType, inputFlightVehileId, inputPilotAmount, inputEngineId, inputFuelContent);
...
class Airplane extends FlightVehile {
    ...
    public Airplane(String flightVehileDesc, String manufacturer, String flightVehileType, String flightVehileId, int pilotAmount, String engineId, double fuelContent) {
        super(flightVehileDesc);

        this.manufacturer = manufacturer;
        this.flightVehileType = flightVehileType;
        this.flightVehileId = flightVehileId;
