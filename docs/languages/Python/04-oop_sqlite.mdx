---
title: "[Python] OOP & SQLite"
tags: [python, oop, sqlite]
keywords: [python, oop, sqlite]
---
...
:::info
相關文章：
1. [SQL 基礎語法-1](https://jeremyho.tw/docs/notes/SQL/guide)
:::
...
### SQLite in Python
:::info
[mbox.text](./file/mbox.txt), from [Programming for Everybody](https://www.coursera.org/specializations/python)
:::
```py
import sqlite3
...
使用 `JOIN` 進行多表關聯式查詢。
:::info
[Library.xml](./file/Library.xml), from [Programming for Everybody](https://www.coursera.org/specializations/python)
:::
```py
...
:::info
[roster_data.json](./file/roster_data.json), from [Programming for Everybody](https://www.coursera.org/specializations/python)
:::
